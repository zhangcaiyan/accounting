...
class User < ActiveRecord::Base
  ...
  has_many :zhichu_fenleis, class_name: "Fenlei", conditions: {shouzhi: :zhichu}, order: "position"
  has_many :shouru_fenleis, class_name: "Fenlei", conditions: {shouzhi: :shouru}, order: "position"
