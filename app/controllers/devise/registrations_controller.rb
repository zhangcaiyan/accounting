...
class Devise::RegistrationsController < ApplicationController
  ...
  prepend_before_filter :authenticate_scope!, :only => [:edit, :update, :destroy, :bianji_mima, :update_password]
  ...
  def update_password
    ...
    if resource.update_with_password(params[resource_name])
      ...
      respond_with resource, :location => bianji_mima_path, notice: "修改密码成功"
    else
      clean_up_passwords resource
      render_with_scope :bianji_mima
    end
  end
